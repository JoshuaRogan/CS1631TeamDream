...
public class CreateCycle1_S1
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		msg23.addPair("Name","Cycle1_S1_"+index);
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		case 601:
			...
			* 	msg614.addPair("Description", "From algorithm instance Cycle1_S1, notify TimeController necessary update of environment variables.");
			* 	msg614.addPair("Name", "Cycle1_S1_"+index);
