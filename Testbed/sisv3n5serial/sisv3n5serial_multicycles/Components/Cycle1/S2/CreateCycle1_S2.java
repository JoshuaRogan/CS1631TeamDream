...
public class CreateCycle1_S2
{
	...
	static final String algorithm = "S2";
	...
	public static void main(String[] args) throws Exception
	{
		...
		msg23.addPair("Name","Cycle1_S2_"+index);
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		case 601:
			...
			* 	msg614.addPair("Description", "From algorithm instance Cycle1_S2, notify TimeController necessary update of environment variables.");
			* 	msg614.addPair("Name", "Cycle1_S2_"+index);
			...
			******************************/
			...
			result.addPair("Description", "Cycle1_S2 Algorithm Analysis Result");
			result.addPair("Name","Cycle1_S2_"+index);
	...
	static String random(String data) {
		Random r = new Random();
		String Result="";
		int randomInt;
