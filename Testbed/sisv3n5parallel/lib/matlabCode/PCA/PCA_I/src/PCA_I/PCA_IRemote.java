...
/**
 * The <code>PCA_IRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  C:\\Users\\admin.sis\\Desktop\\SISv3\\Testbed\\sisv3n5parallel\\lib\\matlabCode\\PCA\\PCA_I.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>PCA_IRemote</code> 
 ...
 * generate RMI server proxy objects for instances of PCA_I.PCA_I.
 */
public interface PCA_IRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>PCA_I</code> M-function with 
     * 4 input arguments.  
     *
     ...
     */
    public Object[] PCA_I(int nargout, Object... rhs) throws RemoteException;
