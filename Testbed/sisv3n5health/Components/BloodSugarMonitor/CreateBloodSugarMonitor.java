...
public class CreateBloodSugarMonitor
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		msg23.addPair("Name","BloodSugarMonitor");
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		Below are the sending messages' attributes list:
			MsgName: BloodSugar data result analysis	MsgID: 1003	Attrs: BloodSugarData; BloodSugarResult
		For more information about KeyValueList, read comments in Util.java.
		****************************************************/
		case 1004:
			System.out.println("Message MsgName:BloodSugar data MsgID:1004 received, start processing.");
			/*************************************************
			Add code below to process Message MsgName:BloodSugar data MsgID:1004
			This message has following attributes: BloodSugarData, use KeyValueList.getValue(String key) to get the values.
			If needed, don't forget to send a msg after processing. See previous comments on how to send a message.
			*************************************************/
			
			KeyValueList msg = new KeyValueList();
			msg.addPair("MsgID","1003");
			msg.addPair("Description","BloodSugar data result analysis");
			msg.addPair("BloodSugarData","Value");
			msg.addPair("BloodSugarResult","Value");
