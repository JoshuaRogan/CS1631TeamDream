...
public class CreateBloodPressureMonitor
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		msg23.addPair("Name","BloodPressureMonitor");
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		Below are the sending messages' attributes list:
			MsgName: BloodPressure data analysis result	MsgID: 1005	Attrs: BloodPressureResult; BloodPressureData
		For more information about KeyValueList, read comments in Util.java.
		****************************************************/
		case 1006:
			System.out.println("Message MsgName:BloodPressure data MsgID:1006 received, start processing.");
			/*************************************************
			Add code below to process Message MsgName:BloodPressure data MsgID:1006
			This message has following attributes: BloodPressureData, use KeyValueList.getValue(String key) to get the values.
			If needed, don't forget to send a msg after processing. See previous comments on how to send a message.
			*************************************************/
			
			KeyValueList msg = new KeyValueList();
			msg.addPair("MsgID","1005");
			msg.addPair("Description","BloodPressure data result analysis");
			msg.addPair("BloodPressureData","Value");
			msg.addPair("BloodPressureResult","Value");
