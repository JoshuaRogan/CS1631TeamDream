...
public class CreatePhone
{
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		****************************************************/
		case 701:
			System.out.println("Message MsgName:Msg1 MsgID:701 received, start processing.");
			...
			*************************************************/
			...
			break;
		case 702:
			System.out.println("Message MsgName:Msg2 MsgID:702 received, start processing.");
			KeyValueList msg712 = new KeyValueList();
			msg712.addPair("MsgID","712");
			msg712.addPair("Description","Acknowledge RequestReport");
			...
			*************************************************/
			...
			break;
		case 703:
			System.out.println("Message MsgName:Msg3 MsgID:703 received, start processing.");
			KeyValueList msg26 = new KeyValueList();
			msg26.addPair("MsgID","26");
			msg26.addPair("Description","Acknowledgement");
			msg26.addPair("AckMsgID","8");
			msg26.addPair("YesNo", "Yes");
			msg26.addPair("Name", "Phone");
