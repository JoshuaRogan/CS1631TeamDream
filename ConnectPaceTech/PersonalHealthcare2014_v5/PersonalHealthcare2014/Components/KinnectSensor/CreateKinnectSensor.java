...
public class CreateKinnectSensor
{
	...
	{
		Runtime.getRuntime().exec("cmd /c C:/Users/Josh/OneDrive/Git/CS1631TeamDream/ConnectPaceTech/PersonalHealthcare2014_v5/PersonalHealthcare2014/Components/Debug/KinectExplorer-WPF.exe");
		...
		msg23.addPair("Name","KinnectSensor");
		...
		while(true)
		{
            ...
            if(inputST.equals("SPEED")){
                System.out.println("Detected a high speed movement.");
            }else if(inputST.equals("Fall")){
                System.out.println("Warning: Detected a fall!!");
            }
		}	
	}
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		Below are the sending messages' attributes list:
			MsgName: KinectToGUI	MsgID: 1016	Attrs:
			MsgName: KinectToUploader	MsgID: 1017	Attrs:
		For more information about KeyValueList, read comments in Util.java.
		****************************************************/
		case 1014:
			System.out.println("Message MsgName:GUIToKinect MsgID:1014 received, start processing.");
			/*************************************************
			Add code below to process Message MsgName:GUIToKinect MsgID:1014
			...
			*************************************************/
			...
			break;
		case 1015:
			System.out.println("Message MsgName:SensorToKinect MsgID:1015 received, start processing.");
			/*************************************************
			Add code below to process Message MsgName:SensorToKinect MsgID:1015
			This message has following attributes: , use KeyValueList.getValue(String key) to get the values.
			If needed, don't forget to send a msg after processing. See previous comments on how to send a message.
			*************************************************/
