...
public class CreateEKG
{
	...
	static void ProcessMsg(KeyValueList kvList) throws Exception
	{
		...
		Below are the sending messages' attributes list:
			MsgName: EKGToGUI	MsgID: 1010	Attrs:
		For more information about KeyValueList, read comments in Util.java.
		****************************************************/
		case 1011:
			System.out.println("Message MsgName:GUIToEKG MsgID:1011 received, start processing.");
			/*************************************************
			Add code below to process Message MsgName:GUIToEKG MsgID:1011
